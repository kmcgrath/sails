module.exports = function(sails) {
	...
	var policyHookDef = {
		...
		bindPolicies: function() {
			...
			//  -> controllers
      //  -> mounts
      console.log(sails.middleware);
      var bindTos = util.merge(util.merge({},sails.middleware.controllers),sails.middleware.mounts);
			_bindPolicies(this.mapping, bindTos);
